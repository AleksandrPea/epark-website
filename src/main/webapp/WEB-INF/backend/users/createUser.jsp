        ...
        <form method="POST" name="createUserForm" id="createUserForm"
            ...
            <div class="form-group validated required">
                ...
                <input type="text" class="form-control" id="login"
                       ...
                       value="${sessionScope[assets.LOGIN_ATTR_NAME]}"/>
            ...
            <div class="form-group required">
                ...
                <input type="text" class="form-control" id="firstName"
                       ...
                       value="${sessionScope[assets.FIRSTNAME_ATTR_NAME]}"/>
            </div>
            ...
            <div class="form-group validated required">
                ...
                <input type="text" class="form-control" id="userEmail"
                       ...
                       value="${sessionScope[assets.EMAIL_ATTR_NAME]}"/>
            ...
            <div class="form-group validated required">
                ...
                <select id="userRole" class="selectpicker form-control" name="${assets.ROLE_PARAM_NAME}">
                    <option value="FORESTER" ${(sessionScope[assets.ROLE_ATTR_NAME] == FORESTER) ? 'selected' : ''}>
                        <fmt:message key="user.role.forester" bundle="${langUser}"/>
                    </option>
                    <option value="TASKMASTER" ${(sessionScope[assets.ROLE_ATTR_NAME] == TASKMASTER) ? 'selected' : ''}>
            ...
            <div class="form-group validated required">
                ...
                <input type="text" class="form-control" id="superiorLogin"
                       ...
                       value="${sessionScope[assets.SUPERIOR_LOGIN_ATTR_NAME]}"/>
