...
public class HandlerProviderImpl implements HandlerProvider {
    ...
    public static final String GET_ALL_USERS_REQUEST_PATTERN = "GET:" + USER_LIST_URI + "/?";
    public static final String GET_CURRENT_USER_REQUEST_PATTERN = "GET:" + DISPLAY_CURRENT_USER_URI + "/?";
    public static final String GET_ONE_USER_REQUEST_PATTERN = "GET:" + DISPLAY_USER_URI + "/\\d+/?";
    public static final String GET_CREATE_USER_REQUEST_PATTERN = "GET:" + CREATE_USER_URI + "/?";
    public static final String POST_CREATE_USER_REQUEST_PATTERN = "POST:" + CREATE_USER_URI + "/?";
    public static final String GET_ONE_TASK_REQUEST_PATTERN = "GET:" + DISPLAY_TASK_URI + "/\\d+/?";
    public static final String GET_USER_TASKS_REQUEST_PATTERN = "GET:" + DISPLAY_USER_TASKS_URI + "/?";
    public static final String GET_CREATE_TASK_REQUEST_PATTERN = "GET:" + CREATE_TASK_URI + "/?";
    public static final String POST_CREATE_TASK_REQUEST_PATTERN = "POST:" + CREATE_TASK_URI + "/?";
    public static final String GET_CREATE_REPORT_REQUEST_PATTERN = "GET:" + CREATE_REPORT_URI + "/\\d+/?";
    public static final String POST_CREATE_REPORT_REQUEST_PATTERN = "POST" + CREATE_REPORT_URI + "/?";
    public static final String GET_ALL_AREAS_REQUEST_PATTERN = "GET:" + AREA_LIST_URI + "/?";
